...
const ensureMeter = async () => {
    ...
    if (!response.ok) {
        throw new Error(`Unable to list meters: ${response.status}. Set SIMULATOR_TOKEN if authentication is enabled.`);
    }
...
const publishReading = async (tick) => {
